...
#plot result
                ...
                ax.scatter(cluster_center_x_not_moving, cluster_center_y_not_moving,0,linewidth=4,
                           facecolors='none', edgecolors=center_color, alpha=0.5,s=center_size)
                ax.text(cluster_center_x_not_moving, cluster_center_y_not_moving,0,  '%s' % (text), size=20, zorder=1,
                        color='k') 

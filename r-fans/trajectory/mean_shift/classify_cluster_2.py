...
#plot result
                ...
                ax.plot(a,b,0,'r')
                ax.plot(a,b2,0,'r')
                ax.scatter(cluster_members_x, cluster_members_y,cluster_members_z,s=0.5,color=color)
		#print color
                ax.scatter(cluster_center_x_not_moving, cluster_center_y_not_moving,0,linewidth=4, color=center_color, alpha=0.5,s=center_size)
